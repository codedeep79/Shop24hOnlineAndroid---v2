...
import com.example.trungnguyenhau.shoponline.Adapter.AdapterViewPagerSlider;
...
import com.example.trungnguyenhau.shoponline.Presenter.ChiTietSanPham.FragmentSliderChiTietSanPham;
...
import com.example.trungnguyenhau.shoponline.Views.DanhGia.DanhSachDanhGiaActivity;
import com.example.trungnguyenhau.shoponline.Views.DanhGia.ThemDanhGiaActivity;
...
public class ChiTietSanPhamActivity extends AppCompatActivity implements ViewChiTietSanPham, ViewPager.OnPageChangeListener,View.OnClickListener {
    ...
    private TextView txtTenSanPham, txtGiaTien, txtTenCHDongGoi, txtThongTinChiTiet, txtXemTatCaNhanXet, txtGioHang, txtGiamGia;
    private Toolbar toolbar;
    private ImageView imXemThemChiTiet, imThemGioHang;
    ...
    public void HienSliderSanPham(String[] linkhinhsanpham) {
        ...
        for (int i = 0; i < linkhinhsanpham.length; i++) {
            ...
            bundle.putString("linkhinh", MainActivity.HOST + linkhinhsanpham[i]);
